...
impl TryFrom<i64> for ParameterName {
    type Error = String;

    fn try_from(value: i64) -> Result<Self, Self::Error> {
        match value {
            201 => Ok(ParameterName::AcquisitionSequenceLength),
            2 => Ok(ParameterName::ApidList),
            3 => Ok(ParameterName::BitLockRequired),
            0 => Ok(ParameterName::BlockingTimeoutPeriod),
            1 => Ok(ParameterName::BlockingUsage),
            4 => Ok(ParameterName::BufferSize),
            202 => Ok(ParameterName::ClcwGlobalVcId),
            203 => Ok(ParameterName::ClcwPhysicalChannel),
            300 => Ok(ParameterName::CopCntrFramesRepetition),
            6 => Ok(ParameterName::DeliveryMode),
            7 => Ok(ParameterName::DirectiveInvocation),
            108 => Ok(ParameterName::DirectiveInvocationOnline),
            8 => Ok(ParameterName::ExpectedDirectiveIdentification),
            9 => Ok(ParameterName::ExpectedEventInvocationIdentification),
            10 => Ok(ParameterName::ExpectedSlduIdentification),
            11 => Ok(ParameterName::FopSlidingWindow),
            12 => Ok(ParameterName::FopState),
            15 => Ok(ParameterName::LatencyLimit),
            16 => Ok(ParameterName::MapList),
            17 => Ok(ParameterName::MapMuxControl),
            18 => Ok(ParameterName::MapMuxScheme),
            19 => Ok(ParameterName::MaximumFrameLength),
            20 => Ok(ParameterName::MaximumPacketLength),
            21 => Ok(ParameterName::MaximumSlduLength),
            204 => Ok(ParameterName::MinimumDelayTime),
            301 => Ok(ParameterName::MinReportingCycle),
            22 => Ok(ParameterName::ModulationFrequency),
            23 => Ok(ParameterName::ModulationIndex),
            205 => Ok(ParameterName::NotificationMode),
            101 => Ok(ParameterName::PermittedControlWordTypeSet),
            302 => Ok(ParameterName::PermittedFrameQuality),
            24 => Ok(ParameterName::PermittedGvcidSet),
            102 => Ok(ParameterName::PermittedTcVcidSet),
            107 => Ok(ParameterName::PermittedTransmissionMode),
            103 => Ok(ParameterName::PermittedUpdateModeSet),
            206 => Ok(ParameterName::Plop1IdleSequenceLength),
            25 => Ok(ParameterName::PlopInEffect),
            207 => Ok(ParameterName::ProtocolAbortMode),
            26 => Ok(ParameterName::ReportingCycle),
            104 => Ok(ParameterName::RequestedControlWordType),
            27 => Ok(ParameterName::RequestedFrameQuality),
            28 => Ok(ParameterName::RequestedGvcid),
            105 => Ok(ParameterName::RequestedTcVcid),
            106 => Ok(ParameterName::RequestedUpdateMode),
            29 => Ok(ParameterName::ReturnTimeoutPeriod),
            30 => Ok(ParameterName::RfAvailable),
            31 => Ok(ParameterName::RfAvailableRequired),
            32 => Ok(ParameterName::SegmentHeader),
            303 => Ok(ParameterName::SequCntrFramesRepetition),
            34 => Ok(ParameterName::SubcarrierToBitRateRatio),
            304 => Ok(ParameterName::ThrowEventOperation),
            35 => Ok(ParameterName::TimeoutType),
            36 => Ok(ParameterName::TimerInitial),
            37 => Ok(ParameterName::TransmissionLimit),
            38 => Ok(ParameterName::TransmitterFrameSequenceNumber),
            39 => Ok(ParameterName::VcMuxControl),
            40 => Ok(ParameterName::VcMuxScheme),
            41 => Ok(ParameterName::VirtualChannel),
            x => Err(format!("Invalid value for ParameterName: {x}")),
        }
    }
}
